            ...
            <div class="row p-3">
                ...
                <div class="col-md-8">
                    <div class="d-sm-flex mb-3 mb-sm-0 justify-content-md-end gap-3">
                        <form action="{{ route('instructor.team.packages') }}" method="get" class="flex-grow-1 flex-md-grow-0">
                            <div class="search-input flex-grow-1 h-100">
                                ...
                                @if (isset($_GET) && count($_GET) > 0)
                                    <a href="{{ route('instructor.team.packages') }}" class="clear-search" data-bs-toggle="tooltip" title="{{ get_phrase('Clear') }}"><i class="fi-rr-cross-circle"></i></a>
                                @endif
                            </div>
                        </form>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-1 mt-1">
                                                        <h4 class="title fs-14px">
                                                            <a href="{{ route('instructor.team.packages.edit', $package->id) }}">{{ ucfirst($package->title) }}</a>
                                                        </h4>
                                                ...
                                                <div class="dAdmin_info_name min-w-150px">
                                                    ...
                                                    @else
                                                        <p>
                                                            ...
                                                            @if ($package->course_price * $package->allocation != $package->price)
                                            ...
                                            <td class="print-d-none text-center">
                                                <div class="dropdown ol-icon-dropdown ol-icon-dropdown-transparent d-flex justify-content-center">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item" href="{{ route('instructor.team.packages.edit', $package->id) }}">{{ get_phrase('Edit') }}</a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item" onclick="confirmModal('{{ route('instructor.team.packages.duplicate', $package->id) }}')" href="javascript:void(0)">{{ get_phrase('Duplicate') }}</a>
                                                        </li>
                                                        @if ($package->status)
                                                            <li>
                                                                <a class="dropdown-item" onclick="confirmModal('{{ route('instructor.team.toggle.status', $package->id) }}')" href="javascript:void(0)">{{ get_phrase('Make As Inactive') }}</a>
                                                            </li>
                                                        @else
                                                            <li>
                                                                <a class="dropdown-item" onclick="confirmModal('{{ route('instructor.team.toggle.status', $package->id) }}')" href="javascript:void(0)">{{ get_phrase('Make As Active') }}</a>
                                                            </li>
                                                        @endif
                                                        <li>
                                                            <a class="dropdown-item" onclick="confirmModal('{{ route('instructor.team.packages.delete', $package->id) }}')" href="javascript:void(0)">{{ get_phrase('Delete') }}</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </td>
