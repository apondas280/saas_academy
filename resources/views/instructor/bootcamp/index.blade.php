                    ...
                    <div class="row mt-3 mb-4">
                        <div class="col-md-6 d-flex align-items-center gap-3">
                            ...
                            @if (isset($_GET) && count($_GET) > 0)
                                <a href="{{ route('instructor.bootcamps', ['type' => request()->route()->parameter('type')]) }}" class="me-2" data-bs-toggle="tooltip" title="{{ get_phrase('Clear') }}"><i class="fi-rr-cross-circle"></i></a>
                            @endif
                        </div>
                        <div class="col-md-6 mt-3 mt-md-0">
                            <form action="{{ route('instructor.bootcamps', ['type' => request()->route()->parameter('type')]) }}" method="get">
