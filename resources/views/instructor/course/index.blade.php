            ...
            <div class="row p-3">
                ...
                <div class="col-md-8">
                    <div class="d-sm-flex mb-3 mb-sm-0 justify-content-md-end gap-3">
                        <form action="{{ route('instructor.courses') }}" method="get" class="flex-grow-1 flex-md-grow-0">
                            <div class="search-input flex-grow-1 h-100">
                                ...
                                @if (isset($_GET) && count($_GET) > 0 && request()->query('search') != '')
                                    <a href="{{ route('instructor.courses') }}" class="clear-search" data-bs-toggle="tooltip" title="{{ get_phrase('Clear') }}"><i class="fi-rr-cross-circle"></i></a>
                                @endif
                            </div>
                        </form>
                            ...
                            <div class="custom-dropdown dropdown-filter @if (!isset($_GET) || (isset($_GET) && count($_GET) == 0))  @endif">
                                <button class="dropdown-header btn ol-btn-light d-flex align-items-center gap-2">
                                    ...
                                    @if (isset($_GET) && count($_GET) && !request()->query('search'))
                                        <a href="{{ route('instructor.courses') }}" class="event-propagation" data-bs-toggle="tooltip" title="{{ get_phrase('Clear') }}"><i class="fi-rr-cross-circle"></i></a>
                                    @endif
                                </button>
