                ...
                <div class="col-xl-7 col-lg-6">
                    <div class="ms-xl-3">
                        ...
                        <p class="subtitle-5 fs-15px lh-25px mb-30px">
                            {{ get_phrase('Training programs can bring you a super exciting experience of learning through online! You never face any negative experience while enjoying your classes.') }}
                        </p>
                        <a href="{{ route('about.us') }}" class="btn btn-danger-1">{{ get_phrase('Learn More') }}</a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="event-details-banner-wrap w-100 d-flex">
                                    <div>
                                        ...
                                        <div class="d-flex align-items-center gap-12px mb-20px">
                                            <div class="lms-author-sm">
                                                @if ($admininfo->photo)
                                                    <img src="{{ asset('/' . $admininfo->photo) }}" alt="">
                                                @else
                                    ...
                                    <div class="lms-event1-banner">
                                        @if ($motivational_speech['image'])
                                            <img src="{{ asset('assets/upload/motivational_speech/' . $motivational_speech['image']) }}" alt="banner">
                                        @else
                                        @endif
                                    </div>
                                </div>
                            ...
                            <a href="{{ route('blog.details', $blog->slug) }}" class="blog-post1-link">
                                <div class="blog-post1-inner">
                                    ...
                                    <div class="blog-post1-details">
                                        <h3 class="title-5">{{ ucfirst($blog->title) }}</h3>
                                        <p class="info ellipsis-line-3">{!! strip_tags($blog->description) !!}</p>
