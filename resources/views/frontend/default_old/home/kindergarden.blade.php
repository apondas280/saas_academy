                ...
                <div class="col-xl-4">
                    <div class="lg-testimonial-titles mb-50px">
                        ...
                        <p class="subtitle-3 fs-15px lh-25px text-xl-start text-center">
                            {{ get_phrase('Having enjoyed a breathlessly successful 2015, there can be no DJ  dynamic set of teaching tools built to be deployed.') }}</p>
                    </div>
                </div>
                <div class="col-xl-8">
                                ...
                                <div class="swiper-slide">
                                    <div class="lms-single-testimonial1">
                                        <div class="single-testimonial1-inner" style="--bg-color: {{ $bgColor }}">
                                            ...
                                            <p class="subtitle-3 fs-15px lh-25px mb-4">{{ $review->review }}</p>
