...
@push('meta')@endpush
@push('css')
    <link rel="stylesheet" href="{{ asset('assets/frontend/default/fonts/plus_jakarta_sans/font.css') }}">
    <style>
        body,
        h1,
        h2,
        ...
        a,
        button {
            font-family: 'plus_jakarta_sans-regular' !important;
        }
        ...
        .subtitle-4,
        .subtitle-5 {
            font-family: 'plus_jakarta_sans-semi-bold' !important;
            font-weight: 500;
        }
        ...
        .title-4,
        .title-5 {
            font-family: 'plus_jakarta_sans-bold' !important;
            font-weight: 700;
        }
    </style>
@endpush
                            ...
                            <a href="{{ route('blog.details', $blog->slug) }}" class="dev-news-link">
                                <div class="dev-news-card">
                                    ...
                                    <div class="dev-news-card-body">
                                        <h5 class="title mb-12">{{ ucfirst($blog->title) }}</h5>
                                        ...
                                        <p class="info ellipsis-line-4">{{ strip_tags($blog->description) }}</p>
                                    </div>
                                </div>
                            </a>
                        </div>
