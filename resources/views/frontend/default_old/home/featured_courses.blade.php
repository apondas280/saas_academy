                        ...
                        <div class="col-lg-8 col-md-8">
                            <div class="entry-details">
                                <div class="entry-title">
                                    ...
                                    @auth
                                        <span class="heart checkPropagation @if ($row->wishlists()->where('course_id', $row->id)->count() > 0) inList @endif" onclick="wishlistToggle('{{ $row->id }}', this)"><i class="fa-regular fa-heart"></i></span>
                                    @endauth
                                </div>
                                <ul>
                                    <li>
