                            ...
                            <div class="lms-1-card rounded-4 lms-card-hover2">
                                <div class="lms-1-card-body p-0">
                                    ...
                                    <div class="p-3">
                                        ...
                                        <h5 class="title-4 fs-18px lh-26px fw-semibold mb-3">{{ ucfirst($row->title) }}</h5>
                                        <div class="d-flex align-items-center gap-2 justify-content-between flex-wrap mb-2">
                                            <div class="mk-card-price d-flex align-items-end gap-1 ">
                                                @if (isset($row->discount_flag) && $row->discount_flag == 1)
                                                    ...
                                                    <p class="mk-old-price">{{ currency(number_format($row->price, 2)) }}</p>
                                            ...
                                            <p class="btn btn-dark-1">{{ get_phrase('Learn More') }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <a href="{{ route('blog.details', $blog->slug) }}" class="mk-blog-body">
                                    <div class="lms-1-card rounded-3">
                                        <div class="lms-1-card-body">
                                            ...
                                            <p class="subtitle-4 fs-15px lh-24px mb-18px ellipsis-line-3">{{ strip_tags($blog->description) }}</p>
