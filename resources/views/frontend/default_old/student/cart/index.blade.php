                ...
                <div class="row">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="my-4 d-flex flex-column justify-content-center">
                                                        <a href="{{ route('course.details', $course->slug) }}" class="cart-item-title ellipsis-2">{{ $course->title }}</a>
                                                        <p class="cart-item-text ellipsis-3">{{ $course->short_description }}</p>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="my-4">
                    ...
                    <div class="col-lg-4">
                        <div class="cart-total-price">
                            <h2 class="text-20">{{ get_phrase('Total') }}</h2>
                            ...
                            <form action="{{ route('payout') }}" method="post" class="mt-20">@csrf
                                ...
                                <div class="mt-20">
                                    ...
                                    <div class="row g-1">
                                        <div class="col-md-8 mb-sm-3 mb-md-0">
                                            <input type="text" class="form-control" name="coupon" placeholder="{{ get_phrase('Apply coupon') }}"
                                                value="{{ request()->query('coupon') }}">
                                        </div>
                                        <div class="col-md-4">
                                            <button type="button" value="{{ get_phrase('Apply') }}" class="form-control eBtn gradient text-white" id="apply-coupon">
                                                {{ get_phrase('Apply') }}
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div class="mt-20">
                                    <input type="submit" class="form-control eBtn gradient text-white" value="{{ get_phrase('Continue to payment') }}"
