                    ...
                    <div class="eNtry-breadcum">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{ get_phrase('Blog Detials') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="ps-box blog-box">
                        ...
                        <div class="details-intro">
                            <div class="figar d-flex align-items-center">
                            ...
                            <h4 class="g-title text-center f-40">{{ $blog_details->title }}</h4>
                        </div>


                        <div class="blog-f-image">
                            <img src="{{ get_image($blog_details->banner) }}" alt="blog-thumbnail">
                            <p class="description">{!! removeScripts($blog_details->description) !!}</p>
                            <ul class="tags">
                                @php
