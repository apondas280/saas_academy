<div class="sidebar blog-sidebar" action="#">
    ...
    <div class="widget border-bottom">
        ...
        <div class="down-text mb-30" id="see-more">
            {{ get_phrase('Show More') }} <i class="fa-solid fa-chevron-down"></i>
        </div>
    </div>
    <div class="widget border-bottom">
        ...
        $(document).ready(function() {
            $('#see-more').on('click', function(e) {
                ...
                if ($(this).hasClass('active')) {
                    ...
                    $('#blog-category').css('height', '400px');
                    $(this).css('margin-top', '0px');
                    $(this).html('Show More <i class="fa-solid fa-chevron-down"></i>');
                }
            });
        });
    </script>
