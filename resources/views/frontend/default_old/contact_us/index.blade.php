        ...
        <div class="container">
            ...
            <div class="row justify-content-center mt-25">
                <div class="col-lg-4 col-md-6 col-sm-6 mb-30">
                    <div class="ol-card p-4 card contact-card">
            ...
            <div class="row section-padding">
                <div class="col-lg-5">
                    <div class="conatact-map">
                        <iframe src="https://maps.google.com/maps?q={{ $contact_info['location'] }}&hl=es&z=14&amp;output=embed" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
                <div class="col-lg-7">
