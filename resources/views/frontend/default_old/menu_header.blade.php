                ...
                <div class="header-menu d-flex justify-content-end">
                    <div class="nav-menu">
                        <ul class="primary-menu main-menu-ul d-flex align-items-center">
                            ...
                            <li class="Esearch">
                                <form action="{{ route('courses') }}" method="get" class="Esearch_entry">
                    ...
                    <div class="floating-searchbar">
                        <button type="button" onclick="this.parentElement.querySelector('form').classList.toggle('show')"><i class="fa-solid fa-magnifying-glass"></i></button>
                    ...
                    <div class="primary-end d-flex align-items-center">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            @isset(auth()->user()->id)
                                <a href="{{ route('cart') }}" class="me-4 position-relative">
                                    @php
                                ...
                                <a href="{{ route('wishlist') }}" class="me-2 position-relative">
                                    @php
                        ...
                        @if (isset(auth()->user()->id))
                            <div class="Userprofile me-2 ms-3">
                                <button class="us-btn dropdown-toggle " type="button" data-bs-toggle="dropdown" aria-expanded="true">
                        ...
                        @else
                            <a href="{{ route('login') }}" class="eBtn btn gradient">{{ get_phrase('Login') }}</a>
                        @endif
            ...
            <div class="offcanvas-body px-4">
                <div class="off-menu">
                    ...
                    <ul class="primary-menu main-menu-ul">
                        ...
                        <li>
                            <a href="{{ route('courses') }}" class="@if (Route::currentRouteName() == 'courses') active @endif">
                                {{ get_phrase('Course') }}
                            </a>
                        </li>
                        <li><a href="{{ route('about.us') }}">{{ get_phrase('About') }}</a></li>

                        <li><a href="{{ route('contact.us') }}">{{ get_phrase('Contact') }}</a></li>
                    </ul>
                    @guest
                        <div class="btn-off">
