            ...
            <div class="row mcg-24">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="course-description-main">
                                ...
                                <div class="abour-instractor-details">
                                    ...
                                    <ul class="instractor-social-link">
                                        <li><a href="{{ $instructor->facebook }}">
                                            ...
                                            <path d="M13.9983 13.499H16.4983L17.4983 9.49902H13.9983V7.49902C13.9983 6.46902 13.9983 5.49902 15.9983 5.49902H17.4983V2.13902C17.1723 2.09602 15.9413 1.99902 14.6413 1.99902C11.9263 1.99902 9.99831 3.65602 9.99831 6.69902V9.49902H6.99831V13.499H9.99831V21.999H13.9983V13.499Z" fill="#6B7385"/>
                                            </g>
                                            <defs>
                        ...
                        <!-- Students Feedback -->
                        <div class="student-feedback-area padding-bottom-110">
                            <div class="course-sub-title">
                            ...
                            <div class="student-feedback-wrap d-flex align-items-center">
                                <div class="feedback-rating-review">
                                    <h1 class="rating">{{ instructor_rating($instructor->id) }}</h1>
                                    <div class="stars">
                                    ...
                                    <p class="reviews">( {{ instructor_reviews($instructor->id) }} )</p>
                                </div>
                                <div class="feedback-rating-progress">
                                    <div class="single-rating-progress d-flex align-items-center">
                                        <h5 class="rating">5<i class="fa-solid fa-star"></i></h5>
                                        <div class="progress-1 progress-width" data-skill="20"></div>
                                        <h5 class="count">15</h5>
                                    </div>
                                    <div class="single-rating-progress d-flex align-items-center">
                                        <h5 class="rating">4<i class="fa-solid fa-star"></i></h5>
                                        <div class="progress-1 progress-width" data-skill="40"></div>
                                        <h5 class="count">10</h5>
                                    </div>
                                    <div class="single-rating-progress d-flex align-items-center">
                                        <h5 class="rating">3<i class="fa-solid fa-star"></i></h5>
                                        <div class="progress-1 progress-width" data-skill="60"></div>
                                        <h5 class="count">6</h5>
                                    </div>
                                    <div class="single-rating-progress d-flex align-items-center">
                                        <h5 class="rating">2<i class="fa-solid fa-star"></i></h5>
                                        <div class="progress-1 progress-width" data-skill="80"></div>
                                        <h5 class="count">4</h5>
                                    </div>
                                    <div class="single-rating-progress d-flex align-items-center">
                                        <h5 class="rating">1<i class="fa-solid fa-star"></i></h5>
                                        <div class="progress-1 progress-width" data-skill="100"></div>
                                        <h5 class="count">1</h5>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="single-feedback-review d-flex">
                                <div class="feedback-review-profile">
                                    <img src="{{ asset('assets/frontend/default/images/course/feedback-review-2.webp') }}" alt="">
                                </div>
                                <div class="feedback-review-details">
                                    <div class="feedback-review-name-date d-flex align-items-center justify-content-between">
                                        ...
                                        <p class="feedback-review-date">12 July, 2023</p>
                                    </div>
                                    <p class="info">It is a long established fact that a reader will be distracted by the read able  content a page when looking at its layout.</p>
                                </div>
                            </div>
                            <div class="single-feedback-review d-flex">
                                <div class="feedback-review-profile">
                                ...
                                <div class="feedback-review-details">
                                    <div class="feedback-review-name-date d-flex align-items-center justify-content-between">
                                        ...
                                        <p class="feedback-review-date">10 July, 2023</p>
                                    </div>
                                    <p class="info">It is a long established fact that a reader will be distracted by the read able  content a page when looking at its layout.</p>
                                </div>
                            </div>
                            </div>
                            <div class="feedback-review-seemore">
                            <a href="javascript:void(0);" class="d-flex align-items-center">
                                <h3 class="text-15">See More</h3>
