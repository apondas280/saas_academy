                ...
                <div class="col-md-12">
                    <div class="top-link-path-area">
                        ...
                        <div class="right-shape-1">
                            <img src="{{ asset('assets/frontend/default/assets/images/path-shape-2.png') }}" alt="">
                        </div>
                        <div class="top-link-path-inner">
                            <h1 class="title">{{ get_phrase('All Courses') }}</h1>
                            <div class="top-link-path d-flex align-items-center justify-content-center">
                                <a href="#">
                                    <img src="{{ asset('assets/frontend/default/assets/images/icons/home-white.svg') }}" alt="">
                                    {{ get_phrase('Home') }}
                                </a>
                                <a href="#">{{ get_phrase('All Courses') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link @if ($layout == 'list') active @endif" id="pills-list-tab" data-bs-toggle="pill" data-bs-target="#pills-list" type="button" role="tab" aria-controls="pills-list" aria-selected="false">
                                                ...
                                                <path d="M20 2.50008C20 2.95841 19.625 3.33341 19.1667 3.33341H0.833333C0.375 3.33341 0 2.95841 0 2.50008C0 2.04175 0.375 1.66675 0.833333 1.66675H19.1667C19.625 1.66675 20 2.04175 20 2.50008ZM5.83333 16.6667H0.833333C0.375 16.6667 0 17.0417 0 17.5001C0 17.9584 0.375 18.3334 0.833333 18.3334H5.83333C6.29167 18.3334 6.66667 17.9584 6.66667 17.5001C6.66667 17.0417 6.29167 16.6667 5.83333 16.6667ZM12.5 9.16675H0.833333C0.375 9.16675 0 9.54175 0 10.0001C0 10.4584 0.375 10.8334 0.833333 10.8334H12.5C12.9583 10.8334 13.3333 10.4584 13.3333 10.0001C13.3333 9.54175 12.9583 9.16675 12.5 9.16675Z" fill="#6B7385"/>
                                                </g>
                                                <defs>
