            ...
            <div class="single-courses">
                ...
                <div class="single-course-inner">
                    <div class="course-img">
                        ...
                        @auth
                            <a href="javascript:void(0);" class="wish-react toggleWishItem" onclick="toggleWishlist('{{ $course->id }}', this)">
                                <div class="wish-icon @if (in_wishlist($course->id)) active @endif">
