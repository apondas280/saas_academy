        ...
        <div class="container">
            ...
            <div class="col-lg-12">
                ...
                <div class="link-path-area link-path-area-pb">
                    <h3 class="text-15">{{ get_phrase('Home') }} / {{ get_phrase('Courses') }} <span>/</span> <span>{{ $blog_details->title }}</span></h3>
                </div>
            </div>
        </div>
    </section>
                        ...
                        <ul class="d-flex align-items-center gap-2 flex-wrap">
                                ...
                                <a href="{{ $blog_details->author_facebook }}" class="lms-svg-link1">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_1544_1063)">
                                            <path
                                                d="M11.6673 11.2498H13.7507L14.584 7.9165H11.6673V6.24984C11.6673 5.3915 11.6673 4.58317 13.334 4.58317H14.584V1.78317C14.3123 1.74734 13.2865 1.6665 12.2032 1.6665C9.94065 1.6665 8.33398 3.04734 8.33398 5.58317V7.9165H5.83398V11.2498H8.33398V18.3332H11.6673V11.2498Z"
                                                fill="#6B7385" />
                                        </g>
                                        <defs>
                            ...
                            <li>
                                <a href="{{ $blog_details->author_linkedin }}" class="lms-svg-link1">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M15.2708 1.71399H18.0835L11.9403 8.73336L19.1667 18.2866H13.5101L9.07646 12.494L4.00882 18.2866H1.1916L7.76104 10.7768L0.833333 1.71399H6.63354L10.6371 7.0085L15.2708 1.71399ZM14.2831 16.6052H15.8407L5.78486 3.30746H4.11194L14.2831 16.6052Z"
                                            fill="#6B7385" />
                                    </svg>
                                </a>
                            </li>
                ...
                <div class="col-lg-5 col-xl-4">
                    <div class="lms3-card p-4">
                        ...
                        <form action="{{ route('blogs') }}" method="get" class="mb-30px">
                            <div>
                                <input type="search" class="form-control lms2-search-form-control" name="search" placeholder="{{ get_phrase('Search...') }}" @if (request()->has('search')) value="{{ request()->input('search') }}" @endif>
    ...
    <section>
        <div class="container">
            <div class="row mrg-30 padding-bottom-110">
                <div class="col-12">
                    <h1 class="text-40">{{ get_phrase('Related Blog') }}</h1>
                </div>
                <!-- Single Blog Card -->
