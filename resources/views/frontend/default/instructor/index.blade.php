                    ...
                    <div class="top-link-path-area2">
                        <div class="top-link-path-inner2">
                            ...
                            <div class="top-link-path d-flex align-items-center justify-content-center">
                                ...
                                <a href="#">{{ get_phrase('Instructors') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <li><a href="{{ $instructor->facebook }}" target="_blank">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <g clip-path="url(#clip0_369_2173)">
                                                        <path
                                                            d="M9.19902 8.89951H10.699L11.299 6.49951H9.19902V5.29951C9.19902 4.68151 9.19902 4.09951 10.399 4.09951H11.299V2.08351C11.1034 2.05771 10.3648 1.99951 9.58482 1.99951C7.95582 1.99951 6.79902 2.99371 6.79902 4.81951V6.49951H4.99902V8.89951H6.79902V13.9995H9.19902V8.89951Z"
                                                            fill="white" />
                                                    </g>
                                                    <defs>
