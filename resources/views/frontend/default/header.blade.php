                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="nav-btn-area login-nav-btn-area d-flex align-items-center">
                                    ...
                                    <div class="header-mobile-search d-block d-lg-none">
                                        <label for="header-mobiel-search" class="mobile-search-label">
                                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M8.625 16.3125C4.3875 16.3125 0.9375 12.8625 0.9375 8.625C0.9375 4.3875 4.3875 0.9375 8.625 0.9375C12.8625 0.9375 16.3125 4.3875 16.3125 8.625C16.3125 12.8625 12.8625 16.3125 8.625 16.3125ZM8.625 2.0625C5.0025 2.0625 2.0625 5.01 2.0625 8.625C2.0625 12.24 5.0025 15.1875 8.625 15.1875C12.2475 15.1875 15.1875 12.24 15.1875 8.625C15.1875 5.01 12.2475 2.0625 8.625 2.0625Z" fill="#4B5675"/>
                                                <path d="M16.5 17.0625C16.3575 17.0625 16.215 17.01 16.1025 16.8975L13.5001 14.295C13.2826 14.0775 13.2826 13.7175 13.5001 13.5C13.7176 13.2825 14.0776 13.2825 14.2951 13.5L16.8975 16.1025C17.115 16.32 17.115 16.68 16.8975 16.8975C16.785 17.01 16.6425 17.0625 16.5 17.0625Z" fill="#4B5675"/>
                                            </svg>                                    
                                        </label>
                            ...
                            <div class="cart-bookmark-lang">
                                @isset(auth()->user()->id)
                                <div class="dropdown header-cart-dropdown active">
                                        ...
                                        <ul class="mb-1">
                                                ...
                                                <a href="#">
                                                    <div class="d-flex align-items-center gap-6px">
                                                        <div class="cart-list-img">
                                                            <img src="{{ asset('assets/frontend/default/images/cart-list-banner1.svg') }}" alt="banner">
                                                        </div>
                                                        <div>
                                                            <h5 class="euclid-title-13px mb-6px">Abode illustrator cc - Essentials training course</h5>
                                                            <p class="pop-subtitle-11px">by Johnson Charles</p>
                                                        </div>
                                                    </div>
                                                </a>
                                            </li>
                                            <li class="mb-12px">
                                                <a href="#">
                                                    <div class="d-flex align-items-center gap-6px">
                                                        <div class="cart-list-img">
                                                            <img src="{{ asset('assets/frontend/default/images/cart-list-banner2.svg') }}" alt="banner">
                                                        </div>
                                                        <div>
                                                            <h5 class="euclid-title-13px mb-6px">Abode illustrator cc - Essentials training course</h5>
                                                            <p class="pop-subtitle-11px">by Johnson Charles</p>
