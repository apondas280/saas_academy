                        ...
                        <div class="table-responsive">
                            <table class="table lms3-table-borderless table-borderless">
                                <thead class="lms3-table-head">
                                    <tr>
                                        <th scope="col"><p class="pop-subtitle-15px2">{{ get_phrase('Items') }}</p></th>
                                        <th scope="col" colspan="2"><p class="pop-subtitle-15px2">{{ get_phrase('Price') }}</p></th>
                                    </tr>
                                </thead>
            ...
            <div class="col-lg-4">
                ...
                <form action="{{ route('payout') }}" method="post">
                    ...
                    <div class="lms3-card">
                        ...
                        <a href="#" class="btn lms2-btn-primary p-10px w-100">Check Out</a>
                    </div>
                </form>
            </div>
        </div>
