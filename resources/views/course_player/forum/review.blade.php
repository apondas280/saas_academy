                    ...
                    <div class="three-dot">
                        ...
                        <ul class="group-menu">
                            @if ($question->user_id == auth()->user()->id)
                                <li>
                                    <a href="javascript:void(0)" class="show-form" id="edit-question" data-question-id="{{ $question->id }}">
                ...
                <div class="">
                    ...
                    <div class="d-flex gap-4">
                        <a href="{{ route('forum.question.likes', $question->id) }}">
                            ...
                            <div class="d-flex align-items-center gap-1 like @if (in_array(auth()->user()->id, $likes)) active @endif">
                        ...
                        <a href="{{ route('forum.question.dislikes', $question->id) }}">
                            ...
                            <div class="d-flex align-items-center gap-1 dislike @if (in_array(auth()->user()->id, $dislikes)) active @endif">
                                <span class="d-inline-flex">
                                    <svg xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="512" height="512">
                                        <path
                        ...
                        <a href="javascript:void(0)" class="show-form" id="reply" data-parent-question-id="{{ $question->id }}">
                            <div class="reply">
                                <span class="d-inline-flex">
