<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="course-playing-header d-flex align-items-center justify-content-between">
                <a href="{{ route('home') }}">
                    <img class="d-none d-lg-block" src="{{ asset(get_frontend_settings('light_logo')) }}" alt="" width="150px">
                </a>
                <div class="playing-video-title">
                    <p class="text-16px mb-0">{{ ucfirst($course_details->title) }}</p>
                </div>
                <div class="playing-header-btns d-flex align-items-center">
                    ...
                    @endif
                    <a href="javascript:void(0);" class="video-zoom-btn" id="fullscreen">
