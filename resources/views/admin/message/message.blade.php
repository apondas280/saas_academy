...
@section('content')
    <div class="row g-4">
        ...
        <div class="col-xl-5 col-lg-6 col-md-5 mt-0">
                ...
                <div class="message-sidebar-header">
                    ...
                    <form action="">
                        <div class="message-sidebar-search">
                            ...
                            <input type="search" class="form-control" onkeyup="loadView('{{ route('view', ['path' => 'admin.message.message_left_side_bar']) }}?thread_code={{ $thread_code ? $thread_code : '' }}&search='+$(this).val(), '#message-user-list')" id="message-sideSearch"
        ...
        <div class="col-xl-7 col-lg-6 col-md-7 mt-0">
            @if ($thread_details)
