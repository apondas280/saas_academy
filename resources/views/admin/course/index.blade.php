    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap flex-md-nowrap">
                <h4 class="section-title">{{ get_phrase('Manage Courses') }}</h4>
            ...
            <div class="row p-3">
                ...
                <div class="col-md-8">
                    <div class="d-sm-flex mb-3 mb-sm-0 justify-content-md-end gap-3">
                        <form action="{{ route('admin.courses') }}" method="get" class="flex-grow-1 flex-md-grow-0">
                            <div class="search-input flex-grow-1 h-100">
                                ...
                                @if (isset($_GET) && count($_GET) > 0)
                                    <a href="{{ route('admin.courses') }}" class="clear-search" data-bs-toggle="tooltip" title="{{ get_phrase('Clear') }}"><i class="fi-rr-cross-circle"></i></a>
                                @endif
                            </div>
                        </form>
                            ...
                            <div class="custom-dropdown dropdown-filter @if (!isset($_GET) || (isset($_GET) && count($_GET) == 0))  @endif">
                                <button class="dropdown-header btn ol-btn-light d-flex align-items-center gap-2">
                                    ...
                                    @if (isset($_GET) && count($_GET) && !request()->query('search'))
                                        <a href="{{ route('admin.courses') }}" class="event-propagation" data-bs-toggle="tooltip" title="{{ get_phrase('Clear') }}"><i class="fi-rr-cross-circle"></i></a>
                                    @endif
                                </button>
                            ...
                            <table class="table eTable eTable-2 print-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="print-d-none text-center">{{ get_phrase('Status') }}</th>
                                            ...
                                            <td class="print-d-none">
                                                <div class="d-flex align-items-center justify-content-center">
                                                    @if ($row->status == 'active')
                                                        <span class="badge rounded-pill text-bg-success">{{ get_phrase('active') }}</span>
                                                    @elseif ($row->status == 'upcoming')
                                                        <span class="badge rounded-pill text-bg-warning">{{ get_phrase('upcoming') }}</span>
                                                    @elseif ($row->status == 'pending')
                                                        <span class="badge rounded-pill text-bg-secondary">{{ get_phrase('pending') }}</span>
                                                    @elseif ($row->status == 'draft')
                                                        <span class="badge rounded-pill text-bg-danger">{{ get_phrase('draft') }}</span>
                                                    @elseif ($row->status == 'inactive')
                                                        <span class="badge rounded-pill text-bg-dark">{{ get_phrase('inactive') }}</span>
                                                    @elseif ($row->status == 'private')
                                                        <span class="badge rounded-pill text-bg-primary">{{ get_phrase('private') }}</span>
                                                    @endif
                                                </div>
                                            </td>
                                            <td>
