            ...
            <div class="row p-3">
                ...
                <div class="col-md-8">
                    <div class="d-sm-flex mb-3 mb-sm-0 justify-content-md-end gap-3">
                        <form action="{{ route('admin.admins.index') }}" method="get" class="flex-grow-1 flex-md-grow-0">
                            <div class="search-input flex-grow-1 h-100">
                                ...
                                @if (isset($_GET) && count($_GET) > 0)
                                    <a href="{{ route('admin.admins.index') }}" class="clear-search" data-bs-toggle="tooltip" title="{{ get_phrase('Clear') }}"><i class="fi-rr-cross-circle"></i></a>
                                @endif
                            </div>
                        </form>
                        ...
                        <div class="d-flex gap-3 mt-3 mt-sm-0">
                            <div class="custom-dropdown">
                                ...
                                <ul class="dropdown-list">
                                    <li>
                                        <a class="dropdown-item export-btn" href="#" onclick="downloadPDF('.print-table', 'admin-list')"><i class="fi-rr-file-pdf"></i> {{ get_phrase('PDF') }}</a>
                                    </li>
                                    <li>
                            ...
                            <table class="table eTable eTable-2 print-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="print-d-none text-center" scope="col">{{ get_phrase('Options') }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($admins as $key => $row)
                                        <tr>
                                            ...
                                            <td class="print-d-none d-flex justify-content-center">
                                                ...
                                                @else
                                                    <span class="badge rounded-pill text-bg-success">{{ get_phrase('Root Admin') }}</span>
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
