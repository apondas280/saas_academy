...
<div class="ol-header print-d-none d-flex align-items-center justify-content-between">
    ...
    <div class="header-content-right d-flex align-items-center justify-content-end">
                ...
                <div class="drop-content">
                    <ul>
                        @foreach (App\Models\Language::get() as $lng)
                            <li class="@if ($activated_language == strtolower($lng->name)) active @endif">
        ...
        <div class="dropdown ol-icon-dropdown ol-icon-dropdown-transparent" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{ get_phrase('Help Center') }}">
            <button class="btn ol-btn-secondary dropdown-toggle header-icon" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1.66669 15C1.66669 12.6988 3.53217 10.8333 5.83335 10.8333H9.16669C11.4679 10.8333 13.3334 12.6988 13.3334 15V16.6667C13.3334 17.1269 12.9603 17.5 12.5 17.5H2.50002C2.03978 17.5 1.66669 17.1269 1.66669 16.6667V15Z" fill="#99A1B7" />
                    <g opacity="0.5">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M14.1667 4.16667C13.2462 4.16667 12.5 4.91286 12.5 5.83333V10.4167C12.5 10.6468 12.6956 10.8313 12.895 10.7165C13.3152 10.4745 13.6998 9.8932 13.9335 9.31855C13.9403 9.30178 13.9437 9.29339 13.9451 9.29031C13.9818 9.2079 14.0385 9.1697 14.1287 9.16678C14.1321 9.16667 14.1436 9.16667 14.1667 9.16667H16.6667C17.5872 9.16667 18.3334 8.42048 18.3334 7.5V5.83333C18.3334 4.91286 17.5872 4.16667 16.6667 4.16667H14.1667Z"
                            fill="#99A1B7" />
                        <path d="M10.8334 5.83333C10.8334 7.67428 9.34097 9.16667 7.50002 9.16667C5.65907 9.16667 4.16669 7.67428 4.16669 5.83333C4.16669 3.99238 5.65907 2.5 7.50002 2.5C9.34097 2.5 10.8334 3.99238 10.8334 5.83333Z" fill="#99A1B7" />
                    </g>
                </svg>
            </button>
