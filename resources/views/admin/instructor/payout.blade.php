                ...
                <div class="col-md-12">
                                ...
                                <div class="d-flex gap-3 mt-3 mt-sm-0">
                                    <div class="custom-dropdown">
                                        ...
                                        <ul class="dropdown-list">
                                            <li>
                                                <a class="dropdown-item export-btn" href="#" onclick="downloadPDF('.print-table', 'instructor-payout-list')"><i class="fi-rr-file-pdf"></i> {{ get_phrase('PDF') }}</a>
                                            </li>
                                            <li>
                    ...
                    <div class="tab-content eNav-Tabs-content" id="myTabContent">
                        <div class="tab-pane fade @if (!isset($_GET['eDateRange'])) show active @endif" id="cHome" role="tabpanel" aria-labelledby="cHome-tab">
                            @if ($instructor_payout_incomplete->count() > 0)
