                        ...
                        <div class="d-flex gap-3 mt-3 mt-sm-0">
                            <div class="custom-dropdown">
                                ...
                                <ul class="dropdown-list">
                                    <li>
                                        <a class="dropdown-item export-btn" href="#" onclick="downloadPDF('.print-table', 'live-course-payment-list')"><i class="fi-rr-file-pdf"></i> {{ get_phrase('PDF') }}</a>
                                    </li>
                                    <li>
                                        ...
                                        <tr>
                                            ...
                                            <td class="print-d-none">
                                                <div class="sub-title2 text-12px text-capitalize d-flex justify-content-center">
                                                    <a href="{{ route('admin.bootcamp.purchase.invoice', $report->id) }}" class="btn ol-btn-outline-secondary d-flex align-items-center cg-10px">
