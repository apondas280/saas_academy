                                            ...
                                            <div class="chart-widget-list">
                                                ...
                                                <p class="border-bottom mb-2 pb-2 text-13px">
                                                    ...
                                                    @else
                                                        ...
                                                        <button class="btn custom_btns ol-btn-primary float-end me-2 py-0 text-13px" onclick="ajaxModal('{{ route('modal', ['admin.setting.save_purchase_code', 'action_type' => 'show']) }}', '{{ get_phrase('Enter valid purchase code') }}')">{{ get_phrase('Enter valid purchase code') }}</button>
                                                    @endif
                                                </p>
