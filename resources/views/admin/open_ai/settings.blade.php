                ...
                <div class="ol-card-body">
                    <form action="{{ route('admin.open.ai.settings.update') }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control ol-form-control" type="number" id="open_ai_max_token" value="{{ get_settings('open_ai_max_token') }}" name="open_ai_max_token" min="20" max="2048" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label ol-form-label" for="ai_secret_key">{{ get_phrase('Secret key') }}</label>
                            <input class="form-control ol-form-control" type="text" id="open_ai_secret_key" value="{{ get_settings('open_ai_secret_key') }}" name="open_ai_secret_key" required="">
                        </div>
