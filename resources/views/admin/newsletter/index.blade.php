                                    ...
                                    <li class="single-accor-item">
                                        <div class="accordion-btn-wrap">
                                            ...
                                            <div class="accordion-button-buttons">
                                                <a onclick="ajaxModal('{{ route('modal', ['admin.newsletter.send', 'id' => $newsletter->id]) }}', '{{ get_phrase('Send newsletter') }}')" data-bs-toggle="tooltip" title="{{ get_phrase('Send Newsletter') }}" href="#" class="edit"><span
                                                        class="fi-rr-paper-plane"></span></a>
                                                <a onclick="ajaxModal('{{ route('modal', ['admin.newsletter.edit', 'id' => $newsletter->id]) }}', '{{ get_phrase('Edit Newsletter') }}')" data-bs-toggle="tooltip" title="{{ get_phrase('Edit') }}" href="#" class="edit"><span
