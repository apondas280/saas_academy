            ...
            <div class="row p-3">
                ...
                <div class="col-md-8">
                    <div class="d-sm-flex mb-3 mb-sm-0 justify-content-md-end gap-3">
                        <form action="{{ route('admin.subscribed_user') }}" method="get" class="flex-grow-1 flex-md-grow-0">
                            <div class="search-input flex-grow-1 h-100">
                                ...
                                @if (isset($_GET) && count($_GET) > 0)
                                    <a href="{{ route('admin.subscribed_user') }}" class="clear-search" data-bs-toggle="tooltip" title="{{ get_phrase('Clear') }}"><i class="fi-rr-cross-circle"></i></a>
                                @endif
                            </div>
                        </form>
                                ...
                                <tbody>
                                    @foreach ($subscribers as $key => $subscriber)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($user_details)
                                                    <span class="badge rounded-pill text-bg-success">{{ get_phrase('Registered User') }}</span>
                                                @else
                                                    <span class="badge rounded-pill text-bg-warning">{{ get_phrase('Not Registered') }}</span>
                                                @endif
                                            </td>
